...
String gaussian_solve (matrix4 <double>& matrix, vector4 <double>& result) {
    ...
    if (std::abs (determinant) < DETERMINANT_DEMINIMUS)
        return String ("matrix is singular/near-singular, determinant: ") + FloatToString (determinant, 12);
...
String gaussian_solve (matrix4 <double>& XtX, vector4 <double>& XtY, vector4 <double>& result) {
    static constexpr double CONDITION_DEMAXIMUS = 1e15;
    static constexpr double DETERMINANT_DEMINIMUS = 1e-10;
    ...
    for (int i = 0; i < 4; i ++) {
        ...
        max_singular = std::max (max_singular, sum_singular);
        min_singular = std::min (min_singular, sum_singular);
    }
    const double condition_number = max_singular / min_singular;
    if (condition_number > CONDITION_DEMAXIMUS)
        return String ("matrix ill-conditioned, condition number estimate: ") + FloatToString (condition_number, 12);
    const double determinant = 
          XtX[0][0] * (XtX[1][1] * XtX[2][2] * XtX[3][3] + XtX[1][2] * XtX[2][3] * XtX[3][1] + XtX[1][3] * XtX[2][1] * XtX[3][2]
                    - XtX[1][3] * XtX[2][2] * XtX[3][1] - XtX[1][2] * XtX[2][1] * XtX[3][3] - XtX[1][1] * XtX[2][3] * XtX[3][2])
        - XtX[0][1] * (XtX[1][0] * XtX[2][2] * XtX[3][3] + XtX[1][2] * XtX[2][3] * XtX[3][0] + XtX[1][3] * XtX[2][0] * XtX[3][2]
                    - XtX[1][3] * XtX[2][2] * XtX[3][0] - XtX[1][2] * XtX[2][0] * XtX[3][3] - XtX[1][0] * XtX[2][3] * XtX[3][2])
        + XtX[0][2] * (XtX[1][0] * XtX[2][1] * XtX[3][3] + XtX[1][1] * XtX[2][3] * XtX[3][0] + XtX[1][3] * XtX[2][0] * XtX[3][1]
                    - XtX[1][3] * XtX[2][1] * XtX[3][0] - XtX[1][1] * XtX[2][0] * XtX[3][3] - XtX[1][0] * XtX[2][3] * XtX[3][1])
        - XtX[0][3] * (XtX[1][0] * XtX[2][1] * XtX[3][2] + XtX[1][1] * XtX[2][2] * XtX[3][0] + XtX[1][2] * XtX[2][0] * XtX[3][1]
                    - XtX[1][2] * XtX[2][1] * XtX[3][0] - XtX[1][1] * XtX[2][0] * XtX[3][2] - XtX[1][0] * XtX[2][2] * XtX[3][1]);
    if (std::abs (determinant) < DETERMINANT_DEMINIMUS)
        return String ("matrix is singular/near-singular, determinant: ") + FloatToString (determinant, 12);
